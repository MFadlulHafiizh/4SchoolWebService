            ...
            <ul class="sidebar-menu">
              ...
              <li class="active"><a class="nav-link" href="/home"><i class="fas fa-map-marker-alt"></i> <span>Maps</span></a>
                <li class="nav-item dropdown">
                  ...
                  <li class="active"><a class="nav-link" href="/crud"><i class="far fa-file-alt"></i> <span>Add Matpel</span></a>
                    <li class="nav-item dropdown">       
                      <li class="active"><a class="nav-link" href="/register"><i class="fas fa-th-large"></i> <span>Add User</span></a>
                        <li class="nav-item dropdown">
                          <li class="active"><a class="nav-link" href="/matery"><i class="fas fa-th-large"></i> <span>Add Materi</span></a>
                            <li class="nav-item dropdown">
                            </li>
                          </div>
                        </div>
