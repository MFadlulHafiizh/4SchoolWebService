...
Route::group(['middleware'=> 'api.role:siswa'], function() {
    Route::post('SiswaSchedule', 'api\SiswaInteractionController@SiswaSchedule');
    Route::get('SiswaSchedule/classRoomData', 'api\SiswaInteractionController@ClassRoomIndex');
});
